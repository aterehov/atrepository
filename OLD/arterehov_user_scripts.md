...
7. В зависимости от выбора пользователя запускается сценарий «Удаление напоминания» или "Изменение напоминания"

# Сценарий 6 - Удаление напоминания

1. Бот спрашивает, уверен ли пользователь, что ему нужно удалить напоминание.
...
# Сценарий 7 - Изменение напоминания

1. Бот просит ввести новый текст напоминания или оставить его без изменений, либо отменить действие.

2. Пользователь вводит новый текст напоминания.

3. Если пользователь выбрал отмену, бот переходит к сценарию «Отображение главного меню».

4. Если пользователь ввел неверный текст, бот сообщает об этом и просит ввести текст заново.

5. Бот просит пользователя ввести новое время первого напоминания или оставить его без изменений, либо отменить действие.

6. Пользователь вводит новое время первого напоминания.

7. Если пользователь выбрал отмену, бот переходит к сценарию «Отображение главного меню».

8. Если пользователь ввел неверное время, бот сообщает об этом и просит ввести другое время.

9. Бот просит ввести новую частоту повторения напоминания или оставить ее без изменения, либо отменить действие.

10. Пользователь вводит новую частоту повторения напоминания.

11. Если пользователь выбрал отмену, бот переходит к сценарию «Отображение главного меню».

12. Если пользователь ввел неверную частоту, бот уведомляет его об этом и просит ввести другую частоту.

13. Бот сохраняет изменения с учетом часового пояса пользователя и возвращается к сценарию «Отображение главного меню».

# Сценарий 8 - Отправка уведомления о напоминании (выполняется без участия пользователя)
